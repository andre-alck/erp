...
class DesenvolvedorTest {
  ...
  @Test
  void
      dadoDesenvolvedorQuandoTestadoMetodoResolverChamadosComMenosUmChamadoEntaoDeveRetornarZero() {
    // preparacao
  ...
  @Test
  void
      dadoDesenvolvedorQuandoTestadoMetodoResolverChamadosComDezChamadosEntaoDeveResolverDezChamados() {
    // preparacao
    Desenvolvedor desenvolvedor = builder.agora();
  ...
  @Test
  void
      dadoDesenvolvedorQuandoTestadoMetodoResolverChamadosComQuantidadesAceitaveisEntaoDeveResolverQuantidadeFornecida() {
    // preparacao
    Desenvolvedor desenvolvedor = builder.agora();
    ...
    for (int certaQuantidadeDeChamados : umMonteDeQuantidadeDeChamados) {
      int quantidadeDeChamadosResolvidos =
          desenvolvedor.resolverChamados(certaQuantidadeDeChamados);
