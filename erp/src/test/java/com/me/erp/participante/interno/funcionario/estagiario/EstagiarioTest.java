...
class EstagiarioTest {
  ...
  @Test
  void
      dadoEstagiarioQuandoTestadoMetodoDocumentarComIdNuloEntaoDeveLancarExcecaoDocumentacaoInvalidaException() {
    // preparacao
    String nulo = null;
    ...
    // acao
    DocumentacaoInvalidaException exception =
        assertThrows(
            DocumentacaoInvalidaException.class, () -> estagiario.documentar(documentacao));
  ...
  @Test
  void
      dadoEstagiarioQuandoTestadoMetodoDocumentarComIdEmBrancoEntaoDeveLancarExcecaoDocumentacaoInvalidaException() {
    // preparacao
    String emBranco = "";
  ...
  @Test
  void
      dadoEstagiarioQuandoTestadoMetodoDocumentarComIdSomenteComEspacosEntaoDeveLancarExcecaoDocumentacaoInvalidaException() {
    // preparacao
  ...
  @Test
  void
      dadoEstagiarioQuandoTestadoMetodoDocumentarComQuantidadeDePaginasMenorDoQueUmaDeveEntaoDeveLancarExcecaoDocumentacaoInvalidaException() {
    // preparacao
    ...
    Documentacao documentacao =
        umDocumentacao()
            .comId(regularDoEstagiario)
            .comQuantidadeDePaginas(zerada)
            .comCriacao(agora)
            .agora();
  ...
  @Test
  void
      dadoEstagiarioQuandoTestadoMetodoDocumentarComDataPosteriorAAgoraEntaoDeveLancarExcecaoDocumentacaoInvalidaException() {
    // preparacao
    ...
    Documentacao documentacao =
        umDocumentacao()
            .comId(regularDoEstagiario)
            .comQuantidadeDePaginas(aceitavel)
            .comCriacao(daquiUmMinutinho)
            .agora();
