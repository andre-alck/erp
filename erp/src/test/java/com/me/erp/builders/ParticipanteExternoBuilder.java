...
public class ParticipanteExternoBuilder {
  ...
  public ParticipanteExternoBuilder comStatusDaRegulamentacaoDoParticipanteExterno(
      StatusDaRegulamentacaoDoParticipanteExterno statusDaRegulamentacaoDoParticipanteExterno) {
    participanteExterno.setStatusDaRegulamentacaoDoParticipanteExterno(
        statusDaRegulamentacaoDoParticipanteExterno);
    return this;
  }
