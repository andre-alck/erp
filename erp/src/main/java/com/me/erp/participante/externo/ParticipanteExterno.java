...
public class ParticipanteExterno extends Participante {
  ...
  public StatusDaRegulamentacaoDoParticipanteExterno
      getStatusDaDocumentacaoDoParticipanteExterno() {
    return statusDaRegulamentacaoDoParticipanteExterno;
  }

  public void setStatusDaRegulamentacaoDoParticipanteExterno(
      StatusDaRegulamentacaoDoParticipanteExterno statusDaRegulamentacaoDoParticipanteExterno) {
  ...
  public void trabalhar(List<String> tarefasConcluidas) throws StatusDoTrabalhoIrregularException {
    if (statusDaRegulamentacaoDoParticipanteExterno
        != StatusDaRegulamentacaoDoParticipanteExterno.REGULAR) {
      throw new StatusDoTrabalhoIrregularException(
