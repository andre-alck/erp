...
public abstract class Supervisor extends Clt {
  public abstract void promover(Funcionario funcionarioASerPromovido)
      throws PromocaoInvalidaException;

  public abstract void demitir(Funcionario funcionarioASerDemitido)
      throws DemissaoInvalidaException;
}
